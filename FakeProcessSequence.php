...
use QuantaQuirk\Contracts\Process\ProcessResult as ProcessResultContract;
...
class FakeProcessSequence
{
     ...
     *
     * @var \QuantaQuirk\Contracts\Process\ProcessResult|\QuantaQuirk\Process\FakeProcessDescription
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Process\ProcessResult|\QuantaQuirk\Process\FakeProcessDescription|array|string  $process
     * @return $this
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Process\ProcessResult|\QuantaQuirk\Process\FakeProcessDescription|array|string  $process
     * @return \QuantaQuirk\Contracts\Process\ProcessResult|\QuantaQuirk\Process\FakeProcessDescription
     */
