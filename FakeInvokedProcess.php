...
use QuantaQuirk\Contracts\Process\InvokedProcess as InvokedProcessContract;
...
class FakeInvokedProcess implements InvokedProcessContract
{
     ...
     *
     * @var \QuantaQuirk\Process\FakeProcessDescription
     */
    protected $process;
     ...
     * @param  \QuantaQuirk\Process\FakeProcessDescription  $process
     * @return void
     */
